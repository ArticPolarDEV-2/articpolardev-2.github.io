    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ['ArticPolarDEV-2/myport', 'ArticPolarDEV-2/Portfolio', 'ArticPolarDEV-2/ArtifactsX-Plugin', 'ArticPolarDEV-2/death-chest', 'ArticPolarDEV-2/ExpurgDay-Spigot', 'ArticPolarDEV-2/articpolardev-2.github.io1'], // These projects will not be displayed. example: ['arifszn/my-project1', 'arifszn/my-project2']
        },
      },
      manual: {
